...
const recipient = ref(dataRecipient);
const pickBouquet = ref(dataPickBouquet);
const bestBouquets = ref(dataBestBouquets);
const specialOffers = ref(dataSpecialOffers);
const underPounds = ref(dataUnderPounds);
</script>
