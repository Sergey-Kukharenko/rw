<template>
  <div class="rating">
    <div class="rating__text">Overall rating</div>
    <div class="rating__group group">
    ...
    <app-stars-rating :rating="props.rating.count" />
    <app-rating-list :rating="props.rating" class="rating__list" />
